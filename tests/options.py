def pytest_addoption(parser):
    group = parser.getgroup('peregovorka')
    ...
    parser.addoption('--user', action='store', dest='username', type=str, default='DIT-VKS-test', help='Username')
    parser.addoption('--password', action='store', dest='password', type=str, default='2LujmfbhL7', help='Password')
